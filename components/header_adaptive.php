        ...
        <div class="menu menu_active">
            ...
            <!-- <div> -->
                ...
                <section class="nav_connection">
                    ...
                    <p class="header_connection_callback ordering_call_2">Заказать обратный звонок</p>
                    <button class="button_calculate_header project_calculation2">Рассчитать проект</button>
                </section>
            <!-- </div> -->
        </div>
    </div>
