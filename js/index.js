...
// на второй слайдер на домашней странице ставим картинки стрелочек
// $('.sobstvennoe_proizvodstvo_slider').slick({
//     prevArrow: '<button type="button" class="slick-prev" style="width: 58px; height: 58px;">' +
//                     '<svg xmlns="http://www.w3.org/2000/svg" width="58" height="58" viewBox="0 0 58 58" fill="none">' +
//                         '<circle cx="28.7461" cy="28.7461" r="28.7461" fill="white"/>' +
//                         '<path d="M37.1152 29.8822C37.9437 29.8822 38.6152 29.2106 38.6152 28.3822C38.6152 27.5538 37.9437 26.8822 37.1152 26.8822V29.8822ZM17.8609 27.3215C17.2751 27.9073 17.2751 28.8571 17.8609 29.4429L27.4068 38.9888C27.9926 39.5746 28.9423 39.5746 29.5281 38.9888C30.1139 38.403 30.1139 37.4533 29.5281 36.8675L21.0428 28.3822L29.5281 19.8969C30.1139 19.3111 30.1139 18.3614 29.5281 17.7756C28.9423 17.1898 27.9926 17.1898 27.4068 17.7756L17.8609 27.3215ZM37.1152 26.8822L18.9215 26.8822V29.8822L37.1152 29.8822V26.8822Z" fill="#618B7E"/>' +
//                     '</svg>' +
//                     // '<svg xmlns="http://www.w3.org/2000/svg" width="58" height="58" viewBox="0 0 58 58" fill="none">' +
//                     //     '<circle cx="28.7461" cy="28.7461" r="27.2461" stroke="white" stroke-width="3"/>' +
//                     //     '<path d="M37.1152 29.8822C37.9437 29.8822 38.6152 29.2106 38.6152 28.3822C38.6152 27.5538 37.9437 26.8822 37.1152 26.8822V29.8822ZM17.8609 27.3215C17.2751 27.9073 17.2751 28.8571 17.8609 29.4429L27.4068 38.9888C27.9926 39.5746 28.9423 39.5746 29.5281 38.9888C30.1139 38.403 30.1139 37.4533 29.5281 36.8675L21.0428 28.3822L29.5281 19.8969C30.1139 19.3111 30.1139 18.3614 29.5281 17.7756C28.9423 17.1898 27.9926 17.1898 27.4068 17.7756L17.8609 27.3215ZM37.1152 26.8822L18.9215 26.8822V29.8822L37.1152 29.8822V26.8822Z" fill="white"/>' +
//                     // '</svg>' +
//                 '</button>',
//     nextArrow: '<button type="button" class="slick-next" style="width: 58px; height: 58px;">' +
//                     '<svg xmlns="http://www.w3.org/2000/svg" width="58" height="58" viewBox="0 0 58 58" fill="none">' +
//                         '<circle cx="28.7461" cy="28.7461" r="28.7461" transform="matrix(-1 0 0 1 57.4922 0)" fill="white"/>' +
//                         '<path d="M20.377 29.8822C19.5485 29.8822 18.877 29.2106 18.877 28.3822C18.877 27.5538 19.5485 26.8822 20.377 26.8822V29.8822ZM39.6313 27.3215C40.2171 27.9073 40.2171 28.8571 39.6313 29.4429L30.0854 38.9888C29.4996 39.5746 28.5499 39.5746 27.9641 38.9888C27.3783 38.403 27.3783 37.4533 27.9641 36.8675L36.4494 28.3822L27.9641 19.8969C27.3783 19.3111 27.3783 18.3614 27.9641 17.7756C28.5499 17.1898 29.4996 17.1898 30.0854 17.7756L39.6313 27.3215ZM20.377 26.8822L38.5707 26.8822V29.8822L20.377 29.8822V26.8822Z" fill="#618B7E"/>' +
//                     '</svg>' +
//                     // '<svg xmlns="http://www.w3.org/2000/svg" width="58" height="58" viewBox="0 0 58 58" fill="none">' +
//                     //     '<circle cx="28.7461" cy="28.7461" r="27.2461" transform="matrix(-1 0 0 1 57.4922 0)" stroke="white" stroke-width="3"/>' +
//                     //     '<path d="M20.377 29.8822C19.5485 29.8822 18.877 29.2106 18.877 28.3822C18.877 27.5538 19.5485 26.8822 20.377 26.8822V29.8822ZM39.6313 27.3215C40.2171 27.9073 40.2171 28.8571 39.6313 29.4429L30.0854 38.9888C29.4996 39.5746 28.5499 39.5746 27.9641 38.9888C27.3783 38.403 27.3783 37.4533 27.9641 36.8675L36.4494 28.3822L27.9641 19.8969C27.3783 19.3111 27.3783 18.3614 27.9641 17.7756C28.5499 17.1898 29.4996 17.1898 30.0854 17.7756L39.6313 27.3215ZM20.377 26.8822L38.5707 26.8822V29.8822L20.377 29.8822V26.8822Z" fill="white"/>' +
...
// страница /catalog, кнопки ДОМА БАНИ МАФ 
// let buttonDoma = document.querySelector('.buttons_houses');
// let buttonBani = document.querySelector('.buttons_bath');
// let buttonMaf = document.querySelector('.buttons_maf');
// let housesBlock  = document.querySelector('.houses_block');
// let bathBlock = document.querySelector('.bath_block');
// let mafBlock = document.querySelector('.maf_block');

// buttonDoma ? buttonDoma.onclick = function() {
//     housesBlock.classList.add('houses_bath_maf_active');
//     bathBlock.classList.remove('houses_bath_maf_active');
//     mafBlock.classList.remove('houses_bath_maf_active');
//     buttonDoma.classList.add('buttons_bath_houses_maf_active');
//     buttonBani.classList.remove('buttons_bath_houses_maf_active');
//     buttonMaf.classList.remove('buttons_bath_houses_maf_active');
// } : null;

// buttonBani ? buttonBani.onclick = function() {
//     housesBlock.classList.remove('houses_bath_maf_active');
//     bathBlock.classList.add('houses_bath_maf_active');
//     mafBlock.classList.remove('houses_bath_maf_active');

//     buttonDoma.classList.remove('buttons_bath_houses_maf_active');
//     buttonBani.classList.add('buttons_bath_houses_maf_active');
//     buttonMaf.classList.remove('buttons_bath_houses_maf_active');
// } : null;

// buttonMaf ? buttonMaf.onclick = function() {
//     housesBlock.classList.remove('houses_bath_maf_active');
//     bathBlock.classList.remove('houses_bath_maf_active');
//     mafBlock.classList.add('houses_bath_maf_active');

//     buttonDoma.classList.remove('buttons_bath_houses_maf_active');
//     buttonBani.classList.remove('buttons_bath_houses_maf_active');
//     buttonMaf.classList.add('buttons_bath_houses_maf_active');
// } : null;

// страница /catalog, кнопки во вкладке "ДОМА" houses_block_foto_2 и houses_block_foto_3, переключение между домом и планом
...
/* конец работы попапа с каталогом */

/* 27.06.2024 работа прокрутки из сайдбара */
// document.getElementById('scrollButton1')?.addEventListener('click', scrollToTop2);
...
//         });
//     } else {
//         console.warn('Элемент targetElement не найден');
//     }
// }

// document.getElementById('scrollButton1')?.addEventListener('click', () => scrollToElement('targetElement1'));
// document.getElementById('scrollButton2')?.addEventListener('click', () => scrollToElement('targetElement2'));
// document.getElementById('scrollButton3')?.addEventListener('click', () => scrollToElement('targetElement3'));
// document.getElementById('scrollButton4')?.addEventListener('click', () => scrollToElement('targetElement4'));
// document.getElementById('scrollButton5')?.addEventListener('click', () => scrollToElement('targetElement5'));
...
/**/
// // Находим все элементы с классом scrollButton
...
//         // Вызываем функцию для прокрутки к элементу с полученным классом
//         scrollToElement(targetClass);
//     });
// });

// // Функция для прокрутки к элементу с заданным классом
...
//     const menu = document.querySelector('.menu');
//     const menuItems = document.querySelectorAll('.header_logo_and_links_list .scrollButton, .nav_logo_and_links_list .scrollButton');
...
//     const hamburger = document.querySelector('.menu_hamburger');
//     const menu = document.querySelector('.menu');
//     const mobileMenuItems = document.querySelectorAll('.header_logo_and_links_list .scrollButton');
//     const desktopMenuItems = document.querySelectorAll('.nav_logo_and_links_list .scrollButton');
...
//             scrollToElementWithOffset(targetClass, 0, offsetMobile);
//             // Закрываем гамбургер-меню
//             if (hamburger.classList.contains('hamburger_active')) {
//                 hamburger.classList.remove('hamburger_active');
//                 menu.classList.add('menu_active');
...
//             scrollToElementWithOffset(targetClass, offsetDesktop, 0);
//         });
//     });
// });

// // Функция прокрутки с учетом смещения
// function scrollToElementWithOffset(targetClass, offsetDesktop, offsetMobile) {
//     const targetElement = document.querySelector(`.${targetClass}`);
//     if (targetElement) {
//         let offset = 0;
...
//             // Мобильная версия (ширина экрана <= 810px)
//             offset = offsetMobile;
//         } else {
//             // Десктопная версия
...
//         // Получаем позицию элемента с учетом смещения
