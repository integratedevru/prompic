...
<head>
    ...
    <title><?= htmlspecialchars($siteConfig['meta']['homepage']['title']) ?></title>
    <meta name="description" content="<?= htmlspecialchars($siteConfig['meta']['homepage']['description']) ?>">
        ...
        <main class="main_section">
            ...
            <section class="proecty_homepage">
                <a href="/catalog-domov" class="proecty_homepage_baths_container">
                    <div class="proecty_homepage_houses">
                        <img src="../img/homepage/project_houses.jpg" alt="Проекты домов фото" loading="lazy" class="proecty_homepage_houses_bg">
                    </div>
                ...
                <div class="proecty_homepage_block_two">
                    <a href="/catalog-bani" class="proecty_homepage_baths_container">
                        <div class="proecty_homepage_baths">
                            <img src="../img/homepage/project_baths.jpg" alt="Проекты бань фото" loading="lazy" class="proecty_homepage_baths_bg">
                        </div>
                    ...
                    <a href="/catalog-besedki" class="proecty_homepage_gazebos_and_mafs_container">
                        <div class="proecty_homepage_gazebos_and_mafs">
                            <img src="../img/homepage/project_gazebos_and_mafs.jpg" alt="Проекты беседок фото" loading="lazy" class="proecty_homepage_gazebos_and_mafs_bg">
                        </div>
            ...
            <section class="homepage_slider_2">
                <div class="homepage_slider_2_container">
                    <div class="sobstvennoe_proizvodstvo_slider">
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto1.jpeg" alt="Slide 1" loading="lazy" class="slider_2_foto_1">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto2.jpeg" alt="Slide 2" loading="lazy" class="slider_2_foto_2">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto3.jpeg" alt="Slide 3" loading="lazy" class="slider_2_foto_3">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto4.jpeg" alt="Slide 4" loading="lazy" class="slider_2_foto_4">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto5.jpeg" alt="Slide 5" loading="lazy" class="slider_2_foto_5">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto6.jpeg" alt="Slide 6" loading="lazy" class="slider_2_foto_6">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto7.jpeg" alt="Slide 7" loading="lazy" class="slider_2_foto_7">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto8.jpeg" alt="Slide 8" loading="lazy" class="slider_2_foto_8">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto9.jpeg" alt="Slide 9" loading="lazy" class="slider_2_foto_9">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto10.jpeg" alt="Slide 10" loading="lazy" class="slider_2_foto_10">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto11.jpeg" alt="Slide 11" loading="lazy" class="slider_2_foto_11">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto12.jpeg" alt="Slide 12" loading="lazy" class="slider_2_foto_12">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto13.jpeg" alt="Slide 13" loading="lazy" class="slider_2_foto_13">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto14.jpeg" alt="Slide 14" loading="lazy" class="slider_2_foto_14">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto15.jpeg" alt="Slide 15" loading="lazy" class="slider_2_foto_14">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto16.jpeg" alt="Slide 16" loading="lazy" class="slider_2_foto_14">
                        </div>
                        <div>
                            <img src="../img/homepage/slider2/slider2_foto17.jpeg" alt="Slide 17" loading="lazy" class="slider_2_foto_14">
                        </div>
                    </div>
                ...
                <div class="kachestvo_breven_section_container">
                    <div class="kachestvo_breven kachestvo_breven_margintop2">
                        <div class="kachestvo_breven_section_one">
                            <img src="../img/page_products/brevno.png" alt="" class="kachestvo_breven_section_one_img" loading="lazy">
            ...
            <section class="chramy_chasovni">
                <div class="chramy_chasovni_container">
                    ...
                    <img src="../img/homepage/hram3_1.png" alt="" class="chramy_chasovni_foto" loading="lazy">
                </div>
            </section>
                    ...
                    <div class="etapy_raboty_block2">
                        <div class="etapy_raboty_block2_card1">
                            <div class="block_relative">
                                <img src="../img/homepage/etapy_raboty1.jpg" alt="" class="etapy_raboty_foto1" loading="lazy">
                                <div class="csifra_etapy_raboty">1</div>
                            </div>
                            <p class="etapy_raboty_block2_card1_text">Оставьте заявку на расчет проекта. С вами свяжется  специалист и поможет составить техническое задание</p>
                        </div>
                        <div class="etapy_raboty_block2_card2">
                            <div class="block_relative">
                                <img src="../img/homepage/etapy_raboty2.jpg" alt="" class="etapy_raboty_foto2" loading="lazy">
                                <div class="csifra_etapy_raboty">2</div>
                            </div>
                            <p class="etapy_raboty_block2_card2_text">Проектирование, 3D-визуализация и сметный расчет производятся бесплатно</p>
                        </div>
                        <div class="etapy_raboty_block2_card3">
                            <div class="block_relative">
                                <img src="../img/homepage/etapy_raboty3.jpg" alt="" class="etapy_raboty_foto3" loading="lazy">
                                <div class="csifra_etapy_raboty">3</div>
                            </div>
                            <p class="etapy_raboty_block2_card3_text">Работаем по договору. Поэтапная 50% предоплата. Можно использовать материнский капитал, военную и сельскую ипотеку</p>
                        </div>
                        <div class="etapy_raboty_block2_card4">
                            <div class="block_relative">
                                <img src="../img/homepage/etapy_raboty4_1.jpg" alt="" class="etapy_raboty_foto4" loading="lazy">
            ...
            <section class="zayavka_na_dom">
                <div class="zayavka_na_dom_container zayavka_na_dom_container_homepage">
                    ...
                    <img src="../img/homepage/zayavka_na_dom_foto2_1.png" alt="" class="zayavka_na_dom_foto zayavka_na_dom_foto_homepage" loading="lazy">
                </div>
            </section>

            <section class="stroitelniye_uslugi_page_text_one stroitelniye_uslugi_margintop_none">
                <div class="stroitelniye_uslugi_page_text_one_container catalog_domov_container">
                    <h2 class="stroitelniye_uslugi_page_text_one_heading stroitelniye_uslugi_page_text_one_text_first stroitelniye_uslugi_page_text_pravki">Почему стоит покупать псковские срубы?</h2>
                    <p class="stroitelniye_uslugi_page_text_one_text">Многие владельцы земельных участков, желающие построить новый дом, сегодня обращают внимание на покупку новых срубов под ключ. Преимуществ у деревянного домостроительства довольно много, что отражается и в опережающих темпах строительства из дерева в России в последние несколько лет. Причин такого роста несколько, одно из немаловажных – переизбыток древесины в нашей стране. Псковская компания "Пром-Пик" ставит срубы в Псковской области и других близлежащих регионах с 1997 года. Построено более 2000 объектов разного размера и типологии (дома, беседки, бани и др.). </p>
                    <p class="stroitelniye_uslugi_page_text_one_text">Псковские срубы являются в какой-то мере брендовым названием. Довольно много успешных компаний работают на этой рынке, поставляя свои домокомплекты в сопредельные регионы. Причина популярности этого бизнеса – наличие качественного экологически чистого леса и добрые руки мастеров, которые многие годы добиваются стабильного качества своих срубов из бревна (или бруса).</p>
                    <p class="stroitelniye_uslugi_page_text_one_text">Покупатели могут купить сруб в Пскове по комфортным ценам и заказать монтаж дома в сжатые сроки. Даже дом в 100 и более квадратов можно собрать под ключ с кровлей и окнами за 2-3 месяца, что сравнимо со скоростью возведения каркасных домов.</p>
                    <p class="stroitelniye_uslugi_page_text_one_text stroitelniye_uslugi_page_text_one_text_last">Но срубы из бревна – это, разумеется, никакая не каркасная конструкция, а, если можно так выразиться, элитное строение по умеренной цене. Жить в Псковском срубе – особое удовольствие и особенный шик ощущения натурального материала. Природа сруба дает комфорт общения с природой, находясь в уютной домашней атмосфере. В срубе из бревна тепло зимой, прохладно летом: комфорт круглый год и качество на десятилетия. Итак, ООО "Пром-Пик" дает однозначно положительный ответ на вопрос "Хороши ли срубы из Пскова?" Да, хороши. Как из Пскова,так и в Пскове, и во всей Псковской области.</p>
                </div>
            </section>
        </main>
