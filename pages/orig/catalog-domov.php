        ...
        <section class="buttons_bath_houses_maf">
            ...
            <section class="stroitelniye_uslugi_page_text_one" style="margin-top: 50px">
                ...
                <h2 class="stroitelniye_uslugi_page_text_one_heading stroitelniye_uslugi_page_text_one_heading_pravki_font" style="margin-top: 0;">Купить сруб дома из бревна в Пскове</h2>
                   <p class="stroitelniye_uslugi_page_text_one_text stroitelniye_uslugi_text_pravki_font">Сруб дома из бревна — это надежное и проверенное временем решение для загородного строительства. Такие дома 
                    подходят как для сезонного проживания, так и для круглогодичного использования в климатических условиях Псковской области и других регионов России.</p>
                   ...
                   <p class="stroitelniye_uslugi_page_text_one_text stroitelniye_uslugi_text_pravki_font"><b>Дом из сруба сохраняет комфортную температуру зимой и прохладу летом, создавая уютную атмосферу для жизни 
                    на десятилетия вперед.</b></p>
