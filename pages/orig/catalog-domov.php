...
<title><?= htmlspecialchars($siteConfig['meta']['catalog-domov']['title']) ?></title>
        <meta name="description" content="<?= htmlspecialchars($siteConfig['meta']['catalog-domov']['description']) ?>">
...
<!-- /Yandex.Metrika counter -->
    ...
    <body>
        ...
        <h1 class="catalog_heading">Псковские бревенчатые дома в нашем каталоге</h1>
<section class="zayavka_na_dom">
                <div class="zayavka_na_dom_container zayavka_na_dom_container_catalog2">
                    ...
                    <img src="../img/homepage/zayavka_na_dom_foto2_1.png" alt="" class="zayavka_na_dom_foto zayavka_na_dom_foto_homepage">
                </div>
            </section>
...
<p class="houses_block_text1">260 000 ₽</p>
            ...
            <section class="stroitelniye_uslugi_page_text_one">
                <div class="stroitelniye_uslugi_page_text_one_container catalog_domov_container">
                    <p class="stroitelniye_uslugi_page_text_one_text stroitelniye_uslugi_page_text_one_text_first">Однако деревянные дома - это не только красота и уникальность, но и практичность. Они идеально подходят для различных климатических условий и могут быть использованы как в летнем доме, так и в круглогодичном жилище.</p>
                    <h2 class="stroitelniye_uslugi_page_text_one_heading">Купить сруб дома из бревна</h2>
                    <p class="stroitelniye_uslugi_page_text_one_text">Покупка деревянного сруба дома - это не только инвестиция в комфортное пространство, но и возможность воплотить в жизнь мечты о жизни в природе.</p>
                    <p class="stroitelniye_uslugi_page_text_one_text">Деревянные срубы обладают невероятной прочностью и долговечностью. Они могут прослужить десятилетиями, сохраняя свою первозданную красоту. При этом они отлично сохраняют тепло внутри дома, создавая комфортное микроклиматическое пространство.</p>
                    <p class="stroitelniye_uslugi_page_text_one_text">Купить деревянный сруб дома - это выбор в пользу экологии и здоровья. Древесина - натуральный и экологически чистый материал, который способствует созданию здоровой атмосферы внутри дома.</p>
                    <p class="stroitelniye_uslugi_page_text_one_text">Когда вы решаете приобрести деревянный сруб дома, вы вкладываете средства не только в недвижимость, но и в свой собственный кусочек природы. Это уникальное вложение, которое будет радовать вас и ваших близких многие годы, и, возможно, даже поколения.</p>
                    <h2 class="stroitelniye_uslugi_page_text_one_heading">Хотите заказать сруб дома в Пскове?</h2>
                    <p class="stroitelniye_uslugi_page_text_one_text">Мы - команда опытных мастеров, специализирующихся на строительстве деревянных домов из срубов, и мы гордимся своей способностью превратить природные материалы в жилища, полные характера и уюта.</p>
                    <p class="stroitelniye_uslugi_page_text_one_text">Что делает нашу компанию уникальной?</p>
                    <ol class="catalog_domov_list1">
                        <li class="catalog_domov_list1_point">Экологически чистые материалы: Мы используем только высококачественное сырье из Псковского леса, которое обеспечивает натуральную теплоизоляцию и создает здоровую атмосферу внутри дома. Наши строения способствуют сохранению окружающей среды.</li>
                        <li class="catalog_domov_list1_point">Индивидуальный дизайн: Мы уважаем уникальность каждого дома и учитываем ваши потребности и предпочтения в создании проекта.</li>
                        <li class="catalog_domov_list1_point">Качество и надежность: Мы предоставляем долгосрочные гарантии на все наши деревянные срубы. Вы можете быть уверены, что ваш дом прослужит долгие годы, сохраняя свою прочность и красоту.</li>
                        <li class="catalog_domov_list1_point">Профессионализм и опыт: Наши мастера имеют богатый опыт в строительстве деревянных домов. Мы знаем все тонкости и секреты создания уникальных срубов.</li>
                    </ol>
                    <p class="stroitelniye_uslugi_page_text_one_text stroitelniye_uslugi_page_text_one_text_last">Если вы ищете надежных и опытных строителей деревянных домов из срубов, способных превратить ваши мечты в реальность, обратитесь к нам. Мы создадим для вас дом, который будет являться не только убежищем, но и произведением искусства, настоящим украшением природы и вашей жизни.</p>
