                ...
                <div class="stage_section_container">
                    <div class="dostavka_container">
                        <div class="dostavka_block1">
                            ...
                            <p class="dostavka_text1">В цены, указанные на сайте, доставка готового домокомплекта (беседки/бани) <b>не входит</b>. Мы рассчитаем стоимость на момент отправки до вашей локации. 
                                Свяжитесь с нами по телефону, чтобы узнать подробности по доставке.</p>
                        </div>
