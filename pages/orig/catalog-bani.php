...
<title><?= htmlspecialchars($siteConfig['meta']['catalog-bani']['title']) ?></title>
        <meta name="description" content="<?= htmlspecialchars($siteConfig['meta']['catalog-bani']['description']) ?>">
