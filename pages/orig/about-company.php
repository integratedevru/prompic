...
<title><?= htmlspecialchars($siteConfig['meta']['about-company']['title']) ?></title>
        <meta name="description" content="<?= htmlspecialchars($siteConfig['meta']['about-company']['description']) ?>">
